...
Public Class MessageBoxManager
    ...
    Public Shared Yes As String = "&Oke (:"
    Public Shared No As String = "&No ):"

    Shared Sub New()
            hook2 = New HookProc(AddressOf MessageBoxHookProc)
        ...
        Public Shared Sub Register()
            ...
            hHook = SetWindowsHookEx(WH_CALLWNDPROCRET, hook2, IntPtr.Zero, AppDomain.GetCurrentThreadId())
        End Sub
